...
class SharedPrefs(context: Context) {
    ...
    fun saveInt(value: Int) {
        sharedPreferences.edit { putInt(INDEX, value) }
    }
    ...
    fun saveWallpaperSetType(value: Int) {
        sharedPreferences.edit { putInt(WALLPAPER_SET_TYPE, value) }
    }
    ...
    private fun saveListToPreferences(list: List<String>) {
        ...
        sharedPreferences.edit { putString(RECENT_SEARCH_LIST, json) }
    }
