...
class SearchWallpapersPagingSource(
    private val wallpaperApi: WallpaperApi, private val query: String
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Photo> {
        try {
            ...
            val response = wallpaperApi.searchWallpaper(query, currentPage)
            Log.d("searchWallpaperResponse", "load: ${response.photos}")
